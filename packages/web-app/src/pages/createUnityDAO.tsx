...
const CreateUnityDAO: React.FC = () => {
  ...
  const [blockchain, daoName, daoSummary, tokenName, tokenSymbol] = useWatch({
    control: formMethods.control,
    name: ['blockchain', 'daoName', 'daoSummary', 'tokenName', 'tokenSymbol'],
  });
  ...
  const daoDetailsIsValid = useMemo(() => {
    ...
    return errors.daoName || errors.daoSummary ? false : true;
  }, [blockchain, daoName, daoSummary, errors.daoName, errors.daoSummary]);

  const daoConfigIsValid = useMemo(() => {
    if (!tokenName || !tokenSymbol) return false;

    return errors.tokenName || errors.tokenSymbol ? false : true;
    ...
    <FormProvider {...formMethods}>
      <CreateDaoProvider>
        ...
        >
          ...
          <Step isNextButtonDisabled={!daoConfigIsValid}>
            <CommunityTokenSetup />
