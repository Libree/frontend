import {Breadcrumb} from '@aragon/ui-components';
            ...
            <Header>
              ...
              <ContentContainer>
                ...
                {(healthFactor as number) > 0 && (
                  <TextContainer>
                    ...
                    <SubtitleContainer>
                      <Description>
                        {t('finance.lending.healthFactor')}
                      </Description>
                    </SubtitleContainer>
                  </TextContainer>
                )}
              ...
              <ContentContainer>
                <TextContainer>
                  ...
                  <SubtitleContainer>
                    <Description>
                      {t('finance.lending.totalCollateral')}
                    </Description>
                  </SubtitleContainer>
                </TextContainer>
      ...
      >
        {collateralList.length === 0 && isAaveLoading ? (
          ...
          <>
            ...
            >
              <ListContainer>
                <LendingTokenList tokens={borrowList.slice(0, 5)} />
              </ListContainer>
            </TransferSectionWrapper>
          </>
        )}
...
const ContentContainer = styled.div.attrs({
  className:
    'flex gap-x-2 gap-y-2 tablet:gap-y-3 tablet:items-start desktop:items-center',
})``;
