...
import {GroupSectionWrapper, PageWrapper} from 'components/wrappers';
  ...
  if (groups.length === 0 && isDesktop)
    return (
      <PageEmptyState
        ...
        onClick={() =>
          navigate(
            generatePath(CreateGroupProposal, {network: network, dao: dao})
          )
        }
      />
    );
            ...
            <Header>
              ...
              <ContentContainer>
                ...
                <ButtonText
                  ...
                  onClick={() =>
                    navigate(
                      generatePath(CreateGroupProposal, {
                        network: network,
                        dao: dao,
                      })
                    )
