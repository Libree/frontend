...
const SelectPlugins: React.FC = () => {
  ...
  return (
    <>
      <Header>
        <Title>{t('createUnityDAO.step2.pluginsTitle')}</Title>
      </Header>
      <PluginsContainer>
        <Controller
          ...
          render={({field: {onChange, value}}) => (
            <ListItemAction
              ...
              onClick={() =>
                handlePluginChanged(!value, 'subGovernancePlugin', onChange)
              }
            />
          )}
        />
        <Controller
          ...
          render={({field: {onChange, value}}) => (
            <ListItemAction
              ...
              onClick={() =>
                handlePluginChanged(!value, 'creditDelegationPlugin', onChange)
              }
            />
          )}
        />
        <Controller
          ...
          render={({field: {onChange, value}}) => (
            <ListItemAction
              ...
              onClick={() =>
                handlePluginChanged(!value, 'vaultPlugin', onChange)
              }
            />
          )}
        />
        <Controller
          ...
          render={({field: {onChange, value}}) => (
            <ListItemAction
              ...
              onClick={() =>
                handlePluginChanged(!value, 'uniswapV3Plugin', onChange)
              }
            />
          )}
        />
