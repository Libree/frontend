...
export const BudgetAllocationCard: React.FC<{
  ...
  const {protocol, token, amount, group} = action.inputs;
  ...
  return (
    ...
    >
      <Container>
        <CardText type="title" title="Protocol" content={protocol} bgWhite />
        <CardText
          type="title"
          title="Amount"
...
const Container = styled.div.attrs({
  className:
    'grid grid-cols-1 tablet:grid-cols-3 bg-ui-50 border border-t-0 border-ui-100 p-2',
})``;
