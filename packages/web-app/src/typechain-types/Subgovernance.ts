...
export interface SubgovernanceInterface extends utils.Interface {
  functions: {
    ...
    "_groupIdCounter()": FunctionFragment;
    ...
    "createGroup(string,address[])": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "_groupIdCounter",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  events: {
    ...
    "MembersAdded(address[],uint256)": EventFragment;
    "MembersRemoved(address[],uint256)": EventFragment;
...
export type MembersAddedEvent = TypedEvent<
  [string[], BigNumber],
  MembersAddedEventObject
>;
...
export interface Subgovernance extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SubgovernanceInterface;
  ...
  _groupIdCounter(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  filters: {
    ...
    "MembersAdded(address[],uint256)"(
      members?: null,
      groupId?: null
    ): MembersAddedEventFilter;
    MembersAdded(members?: null, groupId?: null): MembersAddedEventFilter;

    "MembersRemoved(address[],uint256)"(
      members?: null,
      groupId?: null
    ): MembersRemovedEventFilter;
    MembersRemoved(members?: null, groupId?: null): MembersRemovedEventFilter;
  ...
  populateTransaction: {
    ...
    _groupIdCounter(overrides?: CallOverrides): Promise<PopulatedTransaction>;
